...
import { TableHeaderComponent } from '../../../dashboard/components/User/table-header/table-header.component';
import { TableFooterComponent } from '../../../dashboard/components/User/table-footer/table-footer.component';
import { TableRowComponent } from '../../../dashboard/components/User/table-row/table-row.component';
import { TableActionComponent } from '../../../dashboard/components/User/table-action/table-action.component';
